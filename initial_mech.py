...
# footlocker olympic 7 reverse
base_url = "http://www.footlocker.com/"
URL = "http://www.footlocker.com/product/model:152915/sku:04775400/jordan-retro-7-mens/"
...
# create session
# get from URL, creating cookies and shit
r = requests.get(URL)
html = r.text
referer = r.url
...
print requestKey
response = requests.post('http://www.footlocker.com/catalog/miniAddToCart.cfm?secure=0&', headers=headers, data=load)
